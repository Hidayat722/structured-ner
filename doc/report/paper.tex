...
\begin{abstract}
Named Entity Recognition is a fundamental task for a wide variety of
...
The results are quite reasonable, but not readily portable to other domains or languages. % rules are partly language-dependent
...
\label{table:Results}
\end{table*}
In the following section, we present our experiments and the evaluation of our system.
